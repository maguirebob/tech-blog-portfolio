...
async function main() {
    ...
    const adminPassword = await bcrypt_1.default.hash('AdminPassword123!', 12);
    ...
    const authorPassword = await bcrypt_1.default.hash('AuthorPassword123!', 12);
    ...
    const testPassword = await bcrypt_1.default.hash('TestPassword123!', 12);
...
- File upload system`,
    ...
    await prisma.projectTechnology.createMany({
        data: [
            ...
            { projectId: projects[1].id, technologyId: technologies[0].id },
            { projectId: projects[1].id, technologyId: technologies[1].id },
            { projectId: projects[1].id, technologyId: technologies[4].id },
            { projectId: projects[2].id, technologyId: technologies[0].id },
            { projectId: projects[2].id, technologyId: technologies[4].id }
        ],
        skipDuplicates: true
    });
